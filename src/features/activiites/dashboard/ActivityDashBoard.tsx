...
export default observer( function ActivityDashBoard(){
    ...
    function renderActivityRows(){
       ...
       activityRegistry.forEach(ele =>{
        var _ele = <ActivityRow key={ele.ActivityID} activity={ele}/>;
        output.push(_ele);
       })
       return output;
    ...
    return(
        ...
        <div>
            <Button primary><Icon name="pencil"></Icon> Create Activity</Button>
            <Button color='twitter'><Icon name="pencil"></Icon> Create Activity (option-2)</Button>
        </div>
        <Table celled>
    <Table.Header>
      <Table.Row>
